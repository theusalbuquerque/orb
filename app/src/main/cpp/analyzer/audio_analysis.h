...
struct AnalysisResult{
 ...
 std::string key; std::vector<double> downbeats,phrase_boundaries,vocal_activity_mask,chroma; std::vector<EnergyPoint> energy_curve,low_energy_curve,mid_energy_curve,high_energy_curve; std::vector<MixCuePoint> mix_in_candidates,mix_out_candidates;
};
