...
package com.music.orb.playback.smart.v20

import com.music.orb.playback.smart.*
...
fun planWsolaTransition(
    ...
    val policy = assessTransitionTier20(analysis, nextAnalysis)
